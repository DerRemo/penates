...
const VALIDATORS = {
  ...
  autoRestore: (v) => (typeof v === 'boolean') ? v : undefined,
  autoRestoreContinue: (v) => (typeof v === 'boolean') ? v : undefined,
};

let defaults = { tmuxMouse: 'on', remoteApproval: true, autoRestore: true, autoRestoreContinue: true };
let overrides = {};
...
export const _internal = {
  storePath, storeDir,
  reset() { defaults = { tmuxMouse: 'on', remoteApproval: true, autoRestore: true, autoRestoreContinue: true }; overrides = {}; },
};
