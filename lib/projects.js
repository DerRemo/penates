...
import { toggleItem, addItem, deleteItem, finalizeRelease } from './roadmap-writer.js';
...
<!--
  ...
  Struktur:
    ...
    ## In Entwicklung: vA.B.C    aktuell in Arbeit
    ## Backlog / Ideen            offene Ideen + Entscheidungen
  ...
  Workflow:
    1. Feature planen → als Checkbox in "In Entwicklung" oder "Backlog".
    2. Fertig → Checkbox abhaken (oder im Hub-Detail-View klicken).
    3. Release abschließen → Items von "In Entwicklung" nach "Released"
       verschieben, Narrative ins Changelog schreiben, Version bumpen.
