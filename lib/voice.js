...
import { resolveBin as platformResolveBin } from './platform.js';
...
export function resolveBin() {
  ...
  // OS-agnostischer PATH-Scan (ersetzt die /opt/homebrew-/usr/local-Hardcodes).
  return platformResolveBin('whisper-cli');
}
