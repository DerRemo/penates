...
function attach(project) {
  ...
  // Hat das Projekt (noch) kein Plan-Dokument, gibt es nichts zu beobachten —
  // still überspringen, statt watch() ins ENOENT-Leere laufen und bei jedem
  // syncWatchers erneut „watch failed" loggen zu lassen. Taucht später ein Doc
  // auf, hängt der nächste syncWatchers den Watcher normal an.
