...
Diktieren ist nützlich, wenn die Hände beschäftigt sind, wenn man ein Smartphone mit kleiner Tastatur verwendet, oder wenn man eine längere Anfrage schnell in natürlicher Sprache beschreiben möchte. Da die Transkription lokal erfolgt, verlässt keine Audiodaten das Gerät.
...
- Die `@`-Textinjektion ist Claude-Code-spezifisch. In Codex- oder Antigravity-Sessions wird der Text ebenfalls in die Eingabezeile eingefügt, aber diese CLIs interpretieren die `@`-Mention-Konvention nicht.
