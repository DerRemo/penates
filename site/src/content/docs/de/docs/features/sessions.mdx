...
- **Copy/Paste in der iOS-PWA:** Die installierte iPhone/iPad-App hat kein Hardware-Cmd+C/V, und der tmux-Mouse-Mode blockiert die normale Textauswahl, daher bringt die Touch-Bar im Terminal zwei eigene Tasten mit. **Paste** liest beim Tap die Zwischenablage (iOS zeigt seinen eigenen Paste-Prompt) und fügt sie per Bracketed-Paste ein. **Copy** startet mit Long-Press und Ziehen zur Textauswahl (ein normaler Swipe scrollt weiterhin); Ziehen loslassen und auf **Copy** tippen, um die Auswahl zu kopieren.
