...
**Einstellungen** umfassen sieben Bereiche:
...
- **Server-Steuerung:** Den Hub-Prozess neu starten oder die letzten Zeilen von `logs/stdout.log` und `logs/stderr.log` direkt im Browser anzeigen.
- **Erweitert:** Verschiedene serverseitige Optionen.
...
**Server neu starten:** Im Bereich Server-Steuerung auf **Neu starten** klicken. Der Hub-Prozess startet über den OS-Service-Manager neu (LaunchAgent auf macOS, systemd auf Linux). Der Browser verbindet sich automatisch wieder.
