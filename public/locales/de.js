...
window.__I18N_BUNDLES.de = {
  ...
  'settings.section.restore': 'Session-Wiederherstellung',
  'settings.restore.autoRestore': 'Auto-Restore nach Reboot',
  'settings.restore.continue': 'Konversation fortsetzen',
  'settings.restore.hint': 'Nach einem Reboot oder tmux-Neustart die zuletzt laufenden Sessions wieder hochfahren — je im Verzeichnis, mit fortgesetzter CLI-Konversation. Wirkt erst beim nächsten Start.',
