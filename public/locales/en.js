// EN bundle for Penates — populated during i18n extraction tasks.
...
window.__I18N_BUNDLES.en = {
  ...
  'filebrowser.toast.moved': 'Moved',
  'filebrowser.toast.moveSelfError': "A folder can't be moved into itself.",
  'filebrowser.conflict.title': 'File already exists',
  'filebrowser.conflict.body': '"{name}" already exists in the target folder.',
  'filebrowser.conflict.overwrite': 'Overwrite',
  'filebrowser.conflict.rename': 'Rename',
  'filebrowser.conflict.cancel': 'Cancel',
  ...
  'preview.forbidden': 'Outside the allowed area (session folder or temp only).',
  ...
  'board.implement.confirmBodyKill': 'The current brainstorming session will be ended.',
  'board.move.endSessionTitle': 'Move card & end session?',
  'board.move.endSessionBody': 'This card has a running session ("{name}"). Moving it to another stage will end that session. The worktree is kept.',
  'board.move.endSessionOk': 'Move & end',
  ...
  'projects.missingBadge': 'CHANGELOG.md missing',
  'projects.releasedLabel': 'released',
  'projects.devLabel': 'dev',
  'projects.progress': '{done}/{total} dev · {backlog} backlog',
  'projects.emptyNoFiles': 'No CHANGELOG.md files found.',
  'projects.emptyInstruction': 'Create a CHANGELOG.md in a project under ~/Projects/* — it will be registered on the next server restart.',
  ...
  'projects.filter.hideMissing': 'Hide missing CHANGELOG',
  ...
  'projects.detail.roadmapNotReadable': 'CHANGELOG.md not readable.',
  'projects.detail.roadmapMissingInstruction': 'Create a CHANGELOG.md in this directory and restart the server.',
  ...
  'projects.release.description': 'All items from <strong>In Development</strong> will be moved to <strong>Released</strong>, both version headers bumped, and a new changelog entry inserted at the top. This is a destructive action — make a git commit of CHANGELOG.md first if you version it.',
  ...
  'settings.section.restore': 'Session restore',
  'settings.restore.autoRestore': 'Auto-restore after reboot',
  'settings.restore.continue': 'Continue conversation',
  'settings.restore.hint': 'After a reboot or tmux restart, bring back the sessions that were running — each in its folder, with its CLI conversation continued. Takes effect on the next start.',
  ...
  'settings.updates.checkBtn': 'Check',
  ...
  'settings.updates.badge.outdated': 'Update available',
  'settings.updates.badge.current': 'Up to date',
  'settings.updates.updateBtn': 'Update',
  'settings.updates.guard.upToDate': 'Already up to date.',
  'settings.updates.guard.dirtyTree': 'Local changes present — commit or stash first.',
  'settings.updates.guard.localAhead': 'Local commits ahead of origin (dev checkout) — self-update disabled.',
  'settings.updates.depHint': 'Dependencies update with a Hub release (display only).',
  ...
  // Mata (iOS-Simulator) source-switcher + states
  'preview.source.dev': 'Dev',
  'preview.source.mata': 'Simulator',
  'preview.source.switchAria': 'Preview source',
  'preview.mata.notRunningTitle': 'Mata not running',
  'preview.mata.notRunningBody': 'Start the Mata host app to stream the iOS Simulator.',
  'preview.mata.start': 'Start Mata',
  'preview.mata.startingTitle': 'Starting Mata…',
  'preview.mata.startingBody': 'Launching the Mata host — this can take a moment.',
  'preview.mata.noSimTitle': 'No simulator running',
  'preview.mata.noSimBody': 'Boot an iOS Simulator in Mata, then rescan.',
  'preview.mata.error': 'Could not load the simulator viewer.',
  'mata.capture.btnTitle': 'Simulator → Claude',
  'mata.capture.btnAria': 'Capture simulator to Claude',
  'mata.capture.failed': 'Simulator capture failed',
  'mata.capture.notRunning': 'Mata is not running',
  'mata.capture.injected': 'Simulator screenshot added',
  // Remote-Approval
